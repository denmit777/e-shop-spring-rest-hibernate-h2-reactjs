...
public class UserDAOImpl implements UserDAO {
    ...
    private static final String QUERY_SELECT_ALL_BUYERS_FROM_USERS = "from User u where u.role = 'ROLE_BUYER'";
    ...
    public List<User> getAllBuyers() {
        return entityManager.createQuery(QUERY_SELECT_ALL_BUYERS_FROM_USERS, User.class)
                .getResultList();
    }
}
